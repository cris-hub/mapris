...
import com.mapris.modelo.facade.InscripcionFacade;
...
@FacesConverter(value = "inscripcionConverter")
public class InscripcionConverter implements Converter {

    @Inject
    private InscripcionFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Inscripcion) {
            ...
            return getStringKey(o.getIdInscripciones());
        } else {
