...
INSERT INTO `tg_registro_usuarios` VALUES ('2017-06-02','13:33:07',1234242341);
...
INSERT INTO `usuarios` VALUES (1031174466,'Maria','Lina','Gomez','Carvajal','1997-07-01','1031174466',NULL,1),(1234242341,'Lina','Maria','Riqulmen','Parodia','1993-06-19','1234242341',NULL,2);
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER tg_registro_usuarios AFTER INSERT ON usuarios FOR EACH ROW
begin
insert into registro_usuarios VALUES(curdate(),curtime(),new.cedula);
...
-- Dump completed on 2017-06-05 18:49:53
